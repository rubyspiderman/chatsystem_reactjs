...
Detailled instructions - #please follow these#

https://greenkeytech.atlassian.net/wiki/display/TVBWEB/vector.im+client+setup

Note - we're working from 'master' branch in all repos as develop seems to be too unstable for daily use (testing by Joe and Max)
